 ...
 * generated by Zenith.ai's sandbox simulator — the card says so twice, and the
    ...
    <Card
      ...
      subtitle={
        !deployed
          ...
          : providerIsSandbox
            ? running
              ? `Generated by Zenith.ai's sandbox from r${running.number} — not read from a running process.`
              : runningLoading
          ...
          : `Generated by Zenith.ai's sandbox simulator. ${providerName} does not stream logs to Zenith.ai; these lines were never produced by it.`
      }
      actions={
        <>
          <Chip
            ...
            title={
              wireSimulated === undefined
                ? "The log stream does not label itself yet; everything Zenith.ai generates here is simulated."
