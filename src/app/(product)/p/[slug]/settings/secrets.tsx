          ...
          <ul>
            {store.secrets.map((s) => {
              ...
              const rotateWhy =
                ...
                (ours
                  ? undefined
                  : `${s.ref} is not held by Zenith — it names a value in your own secret manager, which Zenith cannot write to. Rotate it there, then redeploy so the services pick it up.`);
