  ...
  return (
    <section id="providers" className="zenith-providers" aria-labelledby="zenith-providers-title">
      ...
      <div className="zenith-ownership">
        <div className="zenith-export-object" aria-label="Export files: the compatible manifest, Terraform, and an operations README"><div><FileJson2 size={21} aria-hidden="true" /><span>orrery.manifest.json</span><span>01</span></div><div><FileCode2 size={21} aria-hidden="true" /><span>Terraform / *.tf</span><span>02</span></div><div><FileText size={21} aria-hidden="true" /><span>Operations / README.md</span><Download size={17} aria-hidden="true" /></div></div>
