  ...
  return (
    <svg className="gimbal-static" viewBox="0 0 256 256" aria-hidden="true" style={hidden ? { display: "none" } : undefined}>
      <g fill="none" stroke="#8999b2" strokeWidth="2">
        <ellipse cx="128" cy="128" rx="108" ry="84" transform="rotate(32 128 128)" />
        <ellipse cx="128" cy="128" rx="88" ry="54" transform="rotate(-48 128 128)" />
        <ellipse cx="128" cy="128" rx="67" ry="53" transform="rotate(14 128 128)" />
      </g>
