  ...
  return createPortal(
    <div className="fixed inset-0 z-50 grid place-items-center p-4">
      ...
      <div
        ...
        style={{ width }}
        className={cx(
          "relative flex max-h-[85vh] w-full flex-col rounded-card border border-line bg-bg3 shadow-overlay outline-none",
      ...
      >
        ...
        >
          <div className="min-w-0">
            <h2 id={titleId} className="text-[16px] font-medium text-ink">
              {title}
            </h2>
            {description && (
