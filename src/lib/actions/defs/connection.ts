...
defineAction<CreateConn>({
  ...
  async plan(_ctx, input) {
    ...
    return {
      ...
      warnings: planned
        ? [`${adapter.displayName} is planned, not implemented. Use the sandbox to try Zenith end to end, or connect a provider marked available.`]
        : [],
    ...
    return {
      ...
      details: blocked
        ...
        : [
            ...
            "Nothing in your cloud is deleted or changed — Zenith only forgets how to reach it.",
          ],
      costDeltaUsd: 0,
