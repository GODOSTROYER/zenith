...
export const ALERT_KINDS: Record<AlertKind, AlertKindSpec> = {
  health_degraded: {
    ...
    watches:
      "the health Zenith.ai computes for every managed service in this environment, and the transitions it recorded in the last hour",
    severity: "medium",
  },
  deploy_failed: {
...
const SIMULATED_NOTE =
  "Health here is generated by Zenith.ai's log simulator from the deployed revision — nothing was measured against a running process.";
