    ...
    for (const e of s.env) {
      ...
      add({
        ...
        detail:
          ...
          `The fix moves the value into Orrery's secret store — encrypted, out of the manifest — and leaves a reference to it behind, scoped to this service, in one action. ` +
